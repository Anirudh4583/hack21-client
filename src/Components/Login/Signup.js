...
const Signup = ( { handelLogIn,form,onChange,handelSignUp }) => {

    return(

        <div className={`flex flex-col w-full md:w-1/2 ${form}` }>
            ...
            <div
                ...
                <form className="flex flex-col pt-3 md:pt-8">
                    <div className="flex flex-col pt-4">
                        ...
                        <span
                            ...
                            <input onChange={onChange} type="text" id="design-login-email" name='name'
                    ...
                    <div className="flex flex-col pt-4">
                        ...
                        <span
                            ...
                            <input onChange={onChange} type="text" id="design-login-email" name='email'
                                   className=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                   placeholder="Email"/>
                        </div>
                    </div>
                    <div className="flex flex-col pt-4">
                        ...
                        <span
                            ...
                            <input onChange={onChange} type="text"  name='public_address'
                                   className=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                    ...
                    <div className="flex flex-col pt-4 mb-12">
                        <div className="flex relative ">
                            ...
                            <input onChange={onChange} type="password" id="design-login-password" name='password'
                                   className=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                ...
                <div className="pt-12 pb-12 text-center">
                    <p>
                        ...
                        <a  onClick={handelLogIn} className="font-semibold underline cursor-pointer">
                            LogIn here.
                        </a>
                    </p>
                </div>
