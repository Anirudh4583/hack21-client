...
const SignIn = ( { handelRegister,handelLogInUser,onChangeLogIn}) => {
        ...
        <div
            ...
            <form className="flex flex-col pt-3 md:pt-8">
                <div className="flex flex-col pt-4">
                    <div className="flex relative ">
                        ...
                        <input type="text" id="design-login-email" onChange={onChangeLogIn} name='email'
                ...
                <div className="flex flex-col pt-4 mb-12">
                    <div className="flex relative ">
                        ...
                        <input type="password" id="design-login-password" name='password' onChange={onChangeLogIn}
                               className=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                               placeholder="Password"/>
                    </div>
                </div>
                <button onClick={handelLogInUser}
            ...
            <div className="pt-12 pb-12 text-center">
                <p>
                    ...
                    <a  onClick={handelRegister} className="font-semibold underline cursor-pointer">
                        Register here.
                    </a>
                </p>
            </div>
